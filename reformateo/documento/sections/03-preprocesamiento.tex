...
La expresión no se aplica por igual a las cinco instituciones. En Udenar la
suma recorre tres inversores, y en Mariana y la UCC, su único equipo. El
HUDN y CESMAG entregan lectura bruta, de modo que no hay nada que
devolverles y reciben solo el recorte a cero, que en ellos no llega a
actuar ninguna vez porque sus lecturas nunca bajan de cero.

En Udenar los tres equipos no cumplen el mismo papel. El inversor del
proyecto entró en servicio el 3 de septiembre de 2025 y cubre \pct{22.9}
del horizonte; los otros dos registran desde el primer día y son, por
tanto, la única noticia que hay de la generación anterior a esa fecha. Que
sumar los tres sea lo correcto lo dice el propio medidor: desde que el
inversor del proyecto registra, devolverlos deja \emph{exactamente} cero
horas negativas.

El recorte, por tanto, no es una precaución teórica. Actúa en \num{353}
horas de Udenar y en \num{6} de Mariana, y todas ellas caen antes del 3 de
septiembre, es decir, en el tramo que el inversor del proyecto no alcanza.
La subsección~\ref{sub:prep-costo} mide cuánto cuesta.

Cuando la hora no trae lectura de medidor pero sí de inversor, la demanda
de partida se toma como nula y el resultado queda igual a la generación
devuelta. Ocurre en \num{7} horas del horizonte, todas de Udenar, y suma
\uni{34.1}{kWh}.

La Figura~\ref{fig:prep-reconstruccion} confronta las tres series sobre un
mismo eje y muestra el resultado de aplicar esa devolución.
...
gratuito, y lo que cuesta se puede medir. El recorte
actúa cuando la suma de inversores se queda \emph{corta} frente a la
generación que el medidor descontó, porque solo entonces
$D_{\text{neto}} + \sum G$ sigue siendo negativo; si la suma sobrara, el
resultado saldría más positivo, no menos. La causa está identificada y es
de cobertura: las \num{353} horas caen todas antes del 3 de septiembre de
\num{2025}, cuando el inversor del proyecto todavía no registraba, de modo
que la suma devuelve al medidor menos de lo que este había restado y el
recorte lleva a cero la diferencia, eliminando energía de la serie de
demanda.

El fenómeno afecta a \num{353} de las \num{6144} horas del horizonte de
Udenar (el \pct{5.7}), ocurre exclusivamente en la ventana solar, con
máximo a las 13 horas, y elimina en total \uni{1013.3}{kWh}. En Mariana el
mismo recorte actúa en \num{6} horas y elimina \uni{0.6}{kWh}, y en la UCC
no actúa ninguna vez, de modo que el asunto es de Udenar.
...
Hay una sexta que el capítulo no había declarado y que también recorta. La
generación que falta se pone a cero antes de que la etapa de limpieza la
vea, de modo que sus huecos no se interpolan ni se arrastran como los de la
demanda. En la noche eso es correcto, porque el equipo no produce, pero
\num{285} horas de sol del horizonte quedan así con generación nula cuando
lo que hubo fue una avería de registro. Menos generación es menos
excedente que ofrecer, de modo que la decisión empuja el mercado hacia
abajo.

Hay una que apunta al revés. Al estimar la hora incompleta con la media de
