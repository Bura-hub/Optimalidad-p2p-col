...
resultado sale negativo, se toma cero. Ese recorte hace falta porque la
devolución puede pasarse de largo, y la
subsección~\ref{sub:prep-costo} mide cuánto y por qué. En Udenar la suma incluye tres inversores; en Mariana y la UCC,
su único equipo; el HUDN y CESMAG no requieren reconstrucción y reciben
solo un recorte defensivo a cero. Cuando la hora no trae lectura de medidor
pero sí de inversor, la demanda de partida se toma como nula y el resultado
queda igual a la generación devuelta; ocurre en \num{7} horas del horizonte,
todas de Udenar, y suma \uni{34.1}{kWh}. La Figura~\ref{fig:prep-reconstruccion}
...
Hay una que apunta al revés, y se nombra aquí en vez de
