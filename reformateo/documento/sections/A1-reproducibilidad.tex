...
La Figura~\ref{fig:prep-profundidad} del Capítulo~\ref{sec:prep} resume
cada medidor en un renglón, con un panel por frontera, y la distancia entre
sus dos marcas es la gradación que la subsección describe. Las filas que
siguen son las de la frontera principal.
Fila por fila:
