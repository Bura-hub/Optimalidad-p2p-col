...
principal y \num{3588} en la secundaria, y el registro de un equipo no
puede llevar dos valores en el mismo instante. Se resuelve en uno solo
tomando su promedio. Las dos cifras son sobre el archivo completo y no
sobre el horizonte, porque la fusión ocurre antes del recorte; dentro del
horizonte quedan 27 y 29.
...
\begin{figure}[H]
 ...
 \fuente{elaboración propia desde los archivos crudos del Medidor 1 de la
 UCC.}}
...
\begin{enumerate}[leftmargin=*, itemsep=0.35em]
 ...
 etapa de limpieza, que la rellena desde las horas vecinas, o con cero si
 el hueco supera el día, según describe la
...
Conviene además no confundir dos cantidades que se parecen y difieren por un
