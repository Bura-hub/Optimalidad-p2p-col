...
% Pseudocodigo. Se usa algorithmicx (algpseudocode) y no algorithm2e,
% que entra en conflicto con el paquete algorithm. Las palabras clave se
% traducen porque el documento es en espanol.
...
% Los cierres de bloque se componen dentro del paquete, de modo que
% se redefinen como texto de bloque y no como palabra clave suelta.
\algrenewtext{EndIf}{\textbf{fin si}}
\algrenewtext{EndFor}{\textbf{fin para}}
\algrenewtext{EndWhile}{\textbf{fin mientras}}
\algrenewcommand\algorithmiccomment[1]{\hfill\textit{\textcolor{black!55}{#1}}}
\usepackage{titlesec}
\usepackage{setspace}
\usepackage{ragged2e}
\usepackage{amsmath}
...
% Bloques que se conservan en la fuente y no se imprimen. Sirven para
% apartar material sin perderlo: queda en el .tex, recuperable, y las
% correcciones pueden remitir a el.
%
%   \begin{guardado}   ... \end{guardado}     apartado, puede volver
%   \begin{descartado} ... \end{descartado}   descartado, se conserva por
%                                             trazabilidad
%
% Para revisar de una vez todo lo apartado, cambiar excludecomment por
% includecomment en la linea que corresponda y recompilar.
\usepackage{comment}
\excludecomment{guardado}
\excludecomment{descartado}
\usepackage{float}
\usepackage{fancyvrb}
\usepackage{xurl}
...
%  PARTE I — EL DATO
% =====================================================================
\input{sections/02-dato-crudo}
\input{sections/03-preprocesamiento}
\input{sections/04-frontera-medicion}
\input{sections/05-precios}

% =====================================================================
%  PARTE II — EL INSTRUMENTO
% =====================================================================
\input{sections/06-modelo}
\input{sections/07-verificacion}
\input{sections/08-escenarios}

% =====================================================================
%  PARTE III — LA DEPURACIÓN
% =====================================================================
\input{sections/09-depuracion}

% =====================================================================
%  PARTE IV — LA EVIDENCIA
% =====================================================================
\input{sections/10-resultados}
\input{sections/11-robustez}
\input{sections/12-factibilidad}
\input{sections/13-inferencia}

% =====================================================================
%  PARTE V — CIERRE
% =====================================================================
\input{sections/14-discusion}
\input{sections/15-conclusiones}
...
% =====================================================================
\iniciaranexos
\input{sections/A1-reproducibilidad}
\input{sections/A2-registro-decisiones}
\input{sections/A3-trazabilidad}
\input{sections/A4-inventario}
\input{sections/A5-preguntas-abiertas}
\input{sections/A6-lo-no-representado}
