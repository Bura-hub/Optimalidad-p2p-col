...
La diferencia entre unas y otras tiene una explicación instrumental que responde
directamente a por qué el fenómeno aparece en tres instituciones y no en
las cinco. No es de regla sino de grado, y la gobierna una sola cantidad,
que es cuánta generación queda detrás del medidor frente a lo que ese
circuito consume. En Udenar esa fracción llega al \pct{73.8}, de modo que
el flujo se invierte una cuarta parte del horizonte. En Mariana vale el
\pct{21.3} y en la UCC el \pct{11.7}, y la inversión resulta ocasional. En
